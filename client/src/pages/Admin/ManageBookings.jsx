...
function ManageBookings() {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/admin/bookings/${selectedBooking.booking_id}`,
        {
          ...
          <table className="table table-striped table-bordered table-hover">
            <thead className="table-dark">
              <tr>
                ...
                <th className="text-center">From Booking Date</th>
                <th className="text-center">To Booking Date</th>
